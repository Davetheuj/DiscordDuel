...
public static class Utility
{
    ...
    public const string USERNAME_PATTERN = @"^[a-zA-Z0-9]{1,20}$";
    ...
    //    if (password != null)
    //    {
    //        return Regex.IsMatch(password, USERNAME_PATTERN);
    //    }
    //    else 
    //    return false;
    //}
   ...
   /* public static string Sha256FromString(string toEncrypt)
    {
        ...
        System.Security.Cryptography.SHA256Managed hashString = new SHA256Managed();
